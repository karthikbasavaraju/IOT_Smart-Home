...
//    private final SwitchCompat mSwitchAllDay;
    ...
    private final EditText getmEditTextTemperature;
...
//        mSwitchAllDay = (SwitchCompat) findViewById(R.id.switch_all_day);
        ...
        getmEditTextTemperature =findViewById(R.id.temperature);
        mTextInputTemperature = findViewById(R.id.text_input_temperature);
        mToggleButton = findViewById(R.id.device_status);
        ...
        mSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                if(selectedItem.equals("WaterHeater"))
                {
                    getmEditTextTemperature.setVisibility(View.VISIBLE);
                    ...
                    getmEditTextTemperature.setVisibility(View.INVISIBLE);
                    titleN[2]=selectedItem;
                }
                if(titleN[2].equals("WaterHeater")){

                    String k = titleN[0]+" "+titleN[1]+" "+titleN[2]+" "+titleN[3];
                    mEditTextTitle.setText(k);
                }
                else {
                    String k = titleN[0] + " " + titleN[1] + " " + titleN[2];
                    mEditTextTitle.setText(k);
                }
        ...
        getmEditTextTemperature.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                titleN[3]= getmEditTextTemperature.getText().toString();
                String k = titleN[0]+" "+titleN[1]+" "+titleN[2]+" "+titleN[3];
                mEditTextTitle.setText(k);
    ...
    public void setEvent(@NonNull Event event) {
        ...
        if(event.title.length()!=0) {
            String[] even = event.title.split(" ");
            if (even[2].equals("Water")) {
